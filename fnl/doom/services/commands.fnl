...
(local data (or _G._doom_commands_service_data {:command_actions {}}))
(set _G._doom_commands_service_data data)

(local set-command-implementations
  {"nvim-0.5" (fn [name command opts]
                ;; Build the command constructor
                (local cmd-string "command! ")
                ...
                (if (= "string" (type command))
                  ...
                  (do
                    ...
                    (set cmd-string
                         (.. cmd-string
                             (string.format "lua _doom_commands_service_data.command_actions[%d]" uid)))
