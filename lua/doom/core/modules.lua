...
local core_modules = {
    core = {"doom", "nest", "treesitter", "reloader", "updater"}
}
    ...
    if modules._needs_sync then
        vim.api.nvim_create_autocmd("User", {
            ...
            callback = function()
                local logger = require("doom.utils.logging")
                logger.error(
                    "Doom-nvim has been installed.  Please restart doom-nvim.")
            end
        })
    end
end

modules.handle_lazynvim = function() require("lazy").setup(doom.packages) end
