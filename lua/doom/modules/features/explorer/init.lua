...
local function nvim_tree_on_attach(bufnr)
    ...
    vim.keymap.set("n", "<F1>", api.node.show_info_popup,
                   opts("Show info popup"))
    ...
    vim.keymap.set("n", "<2-LeftMouse>", nt_remote.tabnew,
                   opts("Open in treemux"))
    ...
    vim.keymap.set("n", "o", nt_remote.tabnew_main_pane,
                   opts("Open in treemux without tmux split"))
...
explorer.autocmds = {
    {
        "BufEnter", "*", function()
            local name = vim.api.nvim_buf_get_name(vim.api
