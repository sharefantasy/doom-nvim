...
lsp.configs["nvim-lspconfig"] = function()
  ...
  vim.lsp.handlers["textDocument/hover"] = vim.lsp.with(vim.lsp.handlers.hover, { border = doom.border_style })
  vim.lsp.handlers["textDocument/signatureHelp"] =
    vim.lsp.with(vim.lsp.handlers.signature_help, { border = doom.border_style })
  ...
  cmp.setup(vim.tbl_deep_extend("force", doom.features.lsp.settings.completion, {
    ...
    formatting = {
      format = function(entry, item)
        item.kind = string.format("%s %s", doom.features.lsp.settings.completion.kinds[item.kind], item.kind)
