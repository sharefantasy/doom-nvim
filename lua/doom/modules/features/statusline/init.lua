...
statusline.configs["heirline.nvim"] = function()
    ...
    local special, special2, special3 = doom.modules.features.statusline
                                            ._generate_colorscheme()

    local safe_get_highlight = doom.modules.features.statusline
                                   ._safe_get_highlight
    local colors = {
...
statusline.try_refresh = function()
    xpcall(doom.modules.features.statusline.configs["heirline.nvim"],
           debug.traceback)
end
