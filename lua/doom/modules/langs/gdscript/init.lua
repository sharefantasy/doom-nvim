...
gdscript.autocmds = {
    {
        ...
        langs_utils.wrap_language_setup("gdscript", function()
            ...
            if not gdscript.settings.disable_treesitter then
                langs_utils.use_tree_sitter(gdscript.settings
                                                .treesitter_grammars)
            end

            if not gdscript.settings.disable_formatting then
                langs_utils.use_null_ls(gdscript.settings.formatting_package,
            ...
            if not gdscript.settings.disable_diagnostics then
                langs_utils.use_null_ls(gdscript.settings.diagnostics_package,
