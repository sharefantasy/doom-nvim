...
reloader._reload_doom = function()
    ...
    local old_packages = vim.tbl_map(function(t) return t[1] end, doom.packages)
    ...
    local packages = vim.tbl_map(function(t) return t[1] end, doom.packages)
...
reloader.cmds = {{"DoomReload", function() reloader.reload() end}}
