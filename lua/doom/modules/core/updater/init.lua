                            ...
                            vim.defer_fn(function()
                                if merge_error then
                                    ...
                                    if not is_version_unstable(latest_version) then
                                        message = message ..
                                                      ("  Check the changelog at https://github.com/doom-neovim/doom-nvim/releases/tag/%s"):format(
                                                          latest_version)
                                    end
                                    vim.notify(message)
                                end
...
updater.cmds = {
    {"DoomUpdate", function() updater._try_update() end},
    {"DoomCheckUpdates", function() updater.check_updates(false) end}
}
return updater
