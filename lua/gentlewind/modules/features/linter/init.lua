...
linter.configs["null-ls.nvim"] = function()
  ...
  local null_ls_settings = gentlewind.features.linter.settings.null_ls_settings
  null_ls.setup(vim.tbl_deep_extend("force", null_ls_settings, {
    on_attach = function(client)
      if client.server_capabilities.documentFormattingProvider and gentlewind.features.linter.settings.format_on_save then
        vim.cmd [[
