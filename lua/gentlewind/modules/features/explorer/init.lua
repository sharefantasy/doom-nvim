...
explorer.packages = {
  ["nvim-tree.lua"] = {
    ...
    ["tmuxsend.vim"] = { "kiyoon/tmuxsend.vim", "kiyoon/nvim-tree-remote.nvim" },
    ["tmux.nvim"] = { "aserowy/tmux.nvim" },
  },
}
...
explorer.configs["nvim-tree.lua"] = function()
  ...
  if is_module_enabled("features", "lsp") then
    override_table = {
      diagnostics = {
        enable = true,
        icons = {
          hint = gentlewind.features.lsp.settings.icons.hint,
          info = gentlewind.features.lsp.settings.icons.info,
          warning = gentlewind.features.lsp.settings.icons.warn,
          error = gentlewind.features.lsp.settings.icons.error,
        },
      },
    }
  end
  ...
  --   },
  --   filters = {
  --     dotfiles = not gentlewind.show_hidden,
  --   },
  --   git = {
  --     ignore = gentlewind.hide_gitignore,
  --   },
  -- }, gentlewind.features.explorer.settings, override_table)
  local config = gentlewind.features.explorer.settings
