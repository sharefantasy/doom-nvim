...
local utils_g = require("gentlewind.utils")
...
tabline.settings = {
    options = {
        ...
        offsets = {
            ...
            {filetype = "netrw", text = "File Explorer", text_align = "center"},
...
tabline.configs["bufferline.nvim"] = function()
    require("bufferline").setup(gentlewind.features.tabline.settings)
end
