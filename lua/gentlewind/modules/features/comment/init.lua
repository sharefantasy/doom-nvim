...
comment.settings = {
    ...
    pre_hook = function(ctx)
        ...
        if vim.bo.filetype == "typescriptreact" then
            ...
            local type =
                ctx.ctype == comment_utils.ctype.line and "__default" or
                    "__multiline"
            ...
            elseif ctx.cmotion == comment_utils.cmotion.v or ctx.cmotion ==
                comment_utils.cmotion.V then
                location =
...
comment.configs["Comment.nvim"] = function()
    local config = vim.tbl_extend("force", gentlewind.features.comment.settings, {
