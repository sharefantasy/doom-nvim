...
module.use_null_ls = function(package_name, null_ls_path, configure_function)
  ...
  if gentlewind.features.linter then
    ...
    if gentlewind.features.auto_install and package_name ~= nil then
...
module.use_mason_package = function(package_name, success_handler, error_handler)
  ...
  local ok, err = xpcall(function()
    ...
    if not package:is_installed() then
      ...
      local statusline = gentlewind.features.statusline
      if statusline then
...
--- Get LSP capabilities for GENTLEWIND
