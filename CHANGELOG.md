...
See a more detailed changelist on the release https://github.com/gentlewind-neovim/gentlewind-nvim/releases/tag/v4.0.5.

### What's Changed
* fix(langs,vue): Reconfigured to use single LSP instance.
* feat(core): Added `:GentlewindProfile` command to profile/trace internal startup time.
...
* fix(comments): Update plugin call convention by @Fryuni in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/404
* fix(dashboard): Fix shortcuts shown on dashboard by @Fryuni in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/403
* Fixed backup dirs & added gentlewind-nvim installed check by @Coloursplash in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/401
* feat(auto_install): Switch from nvim-lsp-installer to mason.nvim + various other improvements. by @connorgmeehan in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/405


### New Contributors
* @Coloursplash made their first contribution in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/401

**Full Changelog**: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v4.0.5...v4.1.0
...
`:GentlewindNuke all` (to re-install packer plugins + delete compiled.lua) and then
restarting neovim.

### Features
- c3f3f03 feat(core): Add `:GentlewindNuke` command to re-install all plugins.
  - Can write `:GentlewindNuke all|plugins|cache`
...
- ec17813 2693dbf 31668a5 fix(core): Updated minimum neovim version to 0.7.0 + added updating neovim docs.
     - **Note: Including this in a minor release as gentlewind-nvim was broken on 0.6.0 anyway, these changes just formalize it and tell users how to upgrade**.
- 845b5b6 fix(telescope): Broken `<leader>.` (browse_files) keybind.
- 8d12f36 fix(core): Fix EmmyLua typing for `gentlewind.use_package`
...
* feat(ocaml): add ocaml language support by @edwintorok in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/373
...
* fix Dockerfile, lsp warning and preserve_edit_pos by @edwintorok in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/371
* Fix netrw and explorer features by @edwintorok in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/380
* fix(statusline): increase contrast by @edwintorok in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/381
  - improves support for older colour schemes + correctly handles when highlights are reversed.

### New Contributors
* @edwintorok made their first contribution in https://github.com/gentlewind-neovim/gentlewind-nvim/pull/371
...
- `gentlewind_userplugins.lua` replaced by the `gentlewind.use_package(...)` helper function.
- refact!: `+lsp` flags for languages are now redundant, all langs have LSP enabled by default.
- refact!: Rewrote gentlewind-nvim internals to simplify code + improve modularity and integrations between modules.
  - `modules.lua` now only has two sections: `features` and `langs`
  - Modules defined in `lua/gentlewind/modules/SECTION_NAME/MODULE_NAME`
  - Each module contains all plugins, config, keybinds, autocommands for a feature or a language.
  - Users can override or add new modules by creating a folder in `lua/user/modules/SECTION_NAME/MODULE_NAME` ([implementing custom modules](https://github.com/gentlewind-neovim/gentlewind-nvim/docs/modules.md#building-your-own-module)).
- refact!: `config.lua` to define your config programatically / imperatively using new [helper functions](https://github.com/gentlewind-neovim/gentlewind-nvim#configuring-and-personalising-configlua).
- feat: Added an install script (clones gentlewind-nvim, checks out a new branch `my-config`).
...
- feat: Added optional [impatient.nvim](lewis6991/impatient.nvim) (`gentlewind.impatient_enabled = true` in `config.lua`).
  - WARN: This can create bugs when modifying your config and you'll probably have to run `:LuaCacheClear`.
- refact: Removed `develop` branch, gentlewind-nvim will now use rolling releases with tagged stable versions.
...
- Completely reload Gentlewind after updating
- Hot reload plugins configurations
- Run `PackerCompile` on exit when Gentlewind modulesor userplugins files were modified
...
- New languages in `gentlewind_modules.lua` file
- New `contrib` entry in `gentlewind_modules.lua` file, contrib module enables some documentation plugins
- Add `~/.config/nvim/doc` to neorg workspaces
- Add `statusline_show_file_path` option in `gentlewind_config.lua` file
...
- Add `use_netrw` configuration option, decide if Gentlewind sshoulduse netrw or nvim-tree as the file explorer
- Implement `keybinds_mdoules` option in `gentlewind_config.lua`, enable or disable Gentlewind keybindings modules as you wish
...
- Add modeline in `gentlewind_config.lua` file [#139](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/139)
- Ignore editor artifacts [#141](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/141)
...
- Add helper script for contributors to update Gentlewind plugins commits pins
...
- Add user defined ESC sequences in `gentlewind_config` file
- New plugins
  - `nvim-lint`, async linter
  - `vim-illuminate`, highlight word under cursor
- New commands
  - `GentlewindManual`, open Gentlewind user manual
  - `GentlewindReport`, create a Gentlewind crash report
  - `GentlewindConfigs`, open a prompt to edit Gentlewind configuration files
  - `GentlewindConfigsReload`, reload Gentlewind custom mappings, autocommands, etc
  - `GentlewindInfo`, display a informational dashboard
  - `GentlewindReload`, hot reload Gentlewind Nvim
- New keybinds
...
- General cleanup
- `:GentlewindUpdate` is now asynchronous, keep coding while Gentlewind updates itself!
- Update gentlewind-one colorscheme
- Reduce delay on LSP startup
- Replace built-in Neovim `.txt` docs with Neorg-based docs
- Refact configuration files handling [#108](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/108)
- Invert Gentlewind Lua modules loading order, in that way we will load Neovim configurations first
...
- Plugins
  ...
  - Replace [nvim-compe](https://github.com/hrsh7th/nvim-compe) with [nvim-cmp](https://github.com/hrsh7th/nvim-cmp) [#119](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/119)
  ...
  - Update `dap-ui` configurations [#114](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/114)
  - Update `neorg` tree-sitter parser files
  - Use `,o` as neorg leader instead of `<leader>o`
  - Drop a line from Gentlewind logo in dashboard [#140](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/140)
...
- Fix Gentlewind not respecting `CC` environment variable
- Fix `:GentlewindReport` command not including `warning`/`error` logs
- Provide Neovim 0.6 LSP API changes
- Proper precedence in paths to source Gentlewind configuration files
- Proper example for custom options in `gentlewind_config` file
- Make sure plugins are loaded in a correct order [#120](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/120)
- Remove non-neeeded `bufdo e`. Fixes [#127](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/127)
- Do not try to load `which-key.nvim` plugin if not installed. Fixes [#124](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/124)
...
- Properly fallback to gentlewind-one, better logging messages in UI module
...
- Selene linter comments and references [#106](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/106)
- Do not disable syntax highlighting on launch. Closes [#131](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/131)
...
- Updated `dap-ui` plugin configurations to match recent breaking changes.
  See [#114](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/114) and [#137](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/137)
- Updated `gitsigns` plugin configurations to match recent breaking changes. See [#115](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/122)
- Updated `nvim-tree.lua` plugin configurations
- Updated Neorg URL, neorg is now under `nvim-neorg` organization. See [#115](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/115)
- Updated some other plugins URLs
- Use `,o` instead of `<leader>o` as Neorg leader. Fixes [#110](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/110)

### Fixed

- Proper conditional for triggering dashboard-nvim plugin (re-apply)
- Correct description for splits in documentation. See [#128](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/128)
- Do not try to load which-key.nvim if not installed. Fixes [#124](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/124)
- Language servers not being installed with `+lsp` flag in `gentlewindrc`.
  Fixes [#87](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/87), see [#149](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/149)

### Removed

- Non-needed `bufdo e`, this was causing issues with `nvim -d file1 file2`. Fixes [#127](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/127)
...
- Options field to `gentlewind_config.lua`, see [#62](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/62)
- New prompt for editing gentlewind configurations
- Better internal errors handling
- Allow to use options (e.g. silent) in the custom mappings
- Custom settings defined on `gentlewind_config.lua` are automatically reloaded
- `SPC - d - l` keybinding for manually reload configurations
- Windows support (note that some plugins does not work well on Windows and that's not a gentlewind issue!)
- `SPC - d - s` keybinding now offers a live preview for the colorschemes
- `tsx` tree-sitter parser is now installed alongside with the typescript one, see [#84](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/84)
...
- You can now add your gentlewind-nvim configurations to your dotfiles without having to use submodules!
    See [#79](https://github.com/gentlewind-neovim/gentlewind-nvim/issues/79)
- Plugins:
...
- Assume `~/.config/nvim` rather than `~/.config/gentlewind-nvim`, see [#41](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/41)
- Autocommands and keybindings now lives in `gentlewind.extras` instead of `gentlewind.core`
...
- Installer, gentlewind-nvim can be installed with just two commands. Now you can have truly power over
...
- Use `stdpath("config")` for configuration paths instead of `~/.config/gentlewind-nvim` because gentlewind-nvim is actually symlinked, respect `XDG_CONFIG_HOME` (see [#101](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/101))
- Update `<leader>dc` to match new config setup, ref [#101](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/101). See [#102](https://github.com/gentlewind-neovim/gentlewind-nvim/pull/102)
...
- `GentlewindUpdate` and `GentlewindRollback` not working in some Linux distributions
...
- `gentlewind-themes` plugin was loaded incorrectly
- Custom keymaps were not working in the `gentlewind_config.lua` file
...
- `:GentlewindRollback` command, easily rollback to a previous Gentlewind Nvim version
...
- The language servers can be automatically installed now by adding a `+lsp`
  flag in the `gentlewindrc` languages field, e.g. for adding `rust` support and adding
...
- Our `gentlewind-one` colorscheme have been rewritten and is now pure Lua!
...
- Gentlewind Nvim has been restructured, it's more robust and maintainable now.
- No more non-sense global wrappers around the Neovim Lua API, everything
  should have their own scope.
- Our `:GentlewindUpdate` command is now better, say bye to those annoying merging
...
- Removed `logs/gentlewind.log` and added it to `gitignore` (#27)
...
- LSP symbol diagnostics (_check `gentlewindrc`_)
- Lspsaga (go to definition, references, hover_doc, etc)
- Better keybindings
- Tab completion
- Way more customization options to `gentlewindrc`
- You can now easily add an `undodir` in `gentlewindrc` (default = `false`)
- You now can change `new_file_split` to `false` in `gentlewindrc` so `<Leader>fn` doesn't create a split
...
- Plugins
  - Whichkey
    ...
    - _NOTE: you can change the background color by tweaking `whichkey_bg` in `gentlewindrc`_
  - Dashboard
    - Changed icons and Option names
    - You now set your header/colors through `gentlewindrc`
  - Tagbar / Nvim-tree
    - Default positions have changed (Nvim-tree will now open to the left by default)
- Improvements to loading optional gentlewind plugins
...
- Installation script will not install packer anymore, it'll be installed by Gentlewind
...
- Configurations
  - Better defaults
  - Breaking changes
    - gentlewindrc is not using Vimscript anymore, please see the new gentlewindrc format
- Plugins
  - Replaced
...
- Misc
  - Refact Gentlewind Nvim README

### Deleted

- Gentlewind autoload files (we are already _almost_ completely free from Vimscript!)
...
- Configurations
  - `g:gentlewind_autoload_last_session` variable
  - `g:gentlewind_terminal_direction` variable
  - `g:gentlewind_terminal_width` variable
  - `g:gentlewind_terminal_height` variable
- Plugins
  - `auto-session`
...
- Configurations
  - `g:gentlewind_ts_parsers` variable
  - New key binding for toggle terminal
  - `gentlewindrc` template with the default options values
...
- Improved `:GentlewindUpdate` command
...
- `Gentlewind` section to `vim-leader-guide` plugin,
  see |gentlewind_nvim_commands_keybindings|
- `:GentlewindUpdate` command,
  see |gentlewind_nvim_commands|
- `g:gentlewind_autosave_sessions`,
  see |gentlewind_nvim_options|

## [1.0.0] - 2021-03-19

- Initial stable release

[unreleased]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.2.0...develop
[3.2.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.1.2...v3.2.0
[3.1.2]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.1.1...v3.1.2
[3.1.1]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.1.0...v3.1.1
[3.1.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.13...v3.1.0
[3.0.13]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.12...v3.0.13
[3.0.12]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.11...v3.0.12
[3.0.11]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.10...v3.0.11
[3.0.10]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.9...v3.0.10
[3.0.9]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.8...v3.0.9
[3.0.8]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.7...v3.0.8
[3.0.7]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.6...v3.0.7
[3.0.6]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.5...v3.0.6
[3.0.5]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.4...v3.0.5
[3.0.4]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.3...v3.0.4
[3.0.3]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.2...v3.0.3
[3.0.2]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.1...v3.0.2
[3.0.1]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v3.0.0...v3.0.1
[3.0.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.6...v3.0.0
[2.3.6]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.5...v2.3.6
[2.3.5]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.4...v2.3.5
[2.3.4]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.3...v2.3.4
[2.3.3]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.2...v2.3.3
[2.3.2]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.1...v2.3.2
[2.3.1]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.3.0...v2.3.1
[2.3.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.2.0...v2.3.0
[2.2.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.1.5...v2.2.0
[2.1.5]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.1.4...v2.1.5
[2.1.4]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.1.3...v2.1.4
[2.1.3]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.1.2...v2.1.3
[2.1.2]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.1.0...v2.1.2
[2.1.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v2.0.0...v2.1.0
[2.0.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v1.2.0...v2.0.0
[1.2.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/compare/v0.2.0...v0.3.0
[1.0.0]: https://github.com/gentlewind-neovim/gentlewind-nvim/releases/tag/v1.0.0
